...
public class ScreenshotMovie : MonoBehaviour
{
    ...
    public string folder = "D:\\unity_data\\frames_traj(Ycue2)_cw_30k";
    ...
    float[] z = new float[50000];
    float[] vx = new float[50000];
    float[] vz = new float[50000];
    ...
    void ReadCSVFile()
    {
        ...
        StreamReader strReader = new StreamReader("G:\\.shortcut-targets-by-id\\1d9niXcXXKia0fr2gAny7gsRm5eHiA8PC\\sachin_deshmukh_proj\\data_for_border\\traj_Ycue2_30k.csv");
    ...
    void Update()
    {
        ...
        //angle[i] = angle[i];
        transform.position = new Vector3(x[i], 0.5f, z[i]);
